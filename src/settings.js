...
async function showTimezoneSelection(chatId) {
  await bot.sendMessage(chatId, "Укажите разницу во времени относительно UTC (Москва — UTC+3) или отправьте геопозицию:", {
    reply_markup: {
      keyboard: [
  ...
  await bot.sendMessage(chatId, "Выберите разницу:", inlineKeyboard);
}
